...
class EpisodicMemoryService:
    ...
    def calculate_importance_score(
        ...
        # Combine factors
        importance_score = (
            base_score + content_length_factor + type_factor + emotional_factor
        )
    ...
    def retrieve_memories(
        ...
        if query:
            ...
            return self._time_range_search(
                user_id, start_time, end_time, event_types, limit
            )
    ...
    def delete_memory(self, memory_id: str) -> bool:
        ...
        try:
            ...
            if conn:
                with conn.cursor() as cur:
                    cur.execute(
                        "DELETE FROM episodic_memories WHERE id = %s", (memory_id,)
                    )
                    conn.commit()
