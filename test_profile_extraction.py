...
def test_profile_extraction():
    ...
    history = [
        Message(role="user", content="Hi, I'm Alice and I work as a software engineer in San Francisco."),
        Message(role="assistant", content="Nice to meet you, Alice! How's the tech scene in SF?"),
        Message(role="user", content="It's great! I've been coding in Python for 5 years now and I really enjoy it. My goal this year is to learn more about AI and machine learning."),
        Message(role="assistant", content="That's awesome! What kind of projects are you working on?"),
        Message(role="user", content="I'm building a personal finance app. I love hiking in my free time and exploring new restaurants."),
    ]
    ...
    try:
        ...
        print(f"Profile fields stored: {storage_results.get('profile_fields_stored', 0)}")
        ...
        if profile:
            ...
            print(f"Populated fields: {profile['populated_fields']}/{profile['total_fields']}")
